            ...
            switch (_b.label) {
                ...
                case 3:
                    ...
                    generateErrorResult_1 = function (optionalStatus) {
                        var ref = options.ref;
                        var _a = config_1 || {}, _b = _a.params, params = _b === void 0 ? undefined : _b, _c = _a.data, data = _c === void 0 ? undefined : _c, _d = _a.headers, headers = _d === void 0 ? {} : _d;
                        if (ref) {
                            ref(undefined);
                        }
                        return {
                            ...
                            error: error_1,
                            data: response_1 && response_1.data,
                            request: { url: url, params: params, data: data, headers: headers }
                        };
                    };
                    if (options.retry) {
                    ...
                    return [2, generateErrorResult_1()];
                case 4: return [2];
            }
        });
    });
